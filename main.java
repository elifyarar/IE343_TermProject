...
public class Main {
   ...
   // Define the max temperature and cooling rate for the annealing process
     private static final double MAX_TEMPERATURE = 10000;
     private static final double COOLINGRATE=0.03;
     private static int[] values = {68, 64, 47, 55, 72, 53, 81, 68, 72, 88, 62, 42, 48, 47, 68, 51, 48, 68, 83, 55, 48, 44, 49, 68, 63, 71, 82, 55, 60, 63, 56, 75, 42, 76, 42, 60, 75, 68, 67, 42, 71, 58, 66, 72, 67, 78, 49, 50, 51};
...
public static void main(String[] args) {
   ...
   while (temperature > 1) {
   //Generate a new neighbor solution by flipping a random bit
   ...
   //Calculate the fitness value of the neighbor solution
   ...
   //Decide whether to accept or reject the neighbor solution
